...
public class DateSelectionView extends FrameLayout {
    ...
    private String errorText = "Overdue";
    ...
    public void setEnabled(boolean enable)
    {
      super.setEnabled(enable);
        selectDate.setEnabled(enable);
        removeDate.setEnabled(enable);


      if(enable){

          showDate.setTextColor(getResources().getColor(R.color.black));



      }else {
          showDate.setTextColor(getResources().getColor(R.color.yellow_gray));
          selectDate.setColorFilter(getContext().getResources().getColor(R.color.yellow_gray));
          removeDate.setColorFilter(getContext().getResources().getColor(R.color.yellow_gray));
    ...
    public void setError(boolean error){
        super.setEnabled(error);
        if(error){
            findViewById(R.id.date_end).setVisibility(VISIBLE);
            showError.setVisibility(VISIBLE);
            showError.setText(errorText);
